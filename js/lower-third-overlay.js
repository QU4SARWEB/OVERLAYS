(function(){
  ...
  function render(d){
    $('ltTitle').textContent=d.title||''
    $('ltSubtitle').textContent=d.subtitle||''
    $('ltWrap').className='lt-wrap'+(d.visible?'':' hidden')
  }
  ...
  document.addEventListener('DOMContentLoaded',function(){
    ...
    _ch=_sb.channel('lower-third-sync')
    _ch.on('postgres_changes',{event:'*',schema:'public',table:'lower_third',filter:'match_id=eq.'+_mid},function(p){
